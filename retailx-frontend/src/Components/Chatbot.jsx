...
//                 }`}>
//                   {/* 2. Markdown render logic yahan hai */}
//                   {msg.role === 'bot' ? (
...
//               </div>
//             ))}
//             {loading && <div className="text-xs text-gray-400 italic flex items-center gap-2"><div className="w-1 h-1 bg-gray-400 rounded-full animate-bounce"></div>RetailX typing...</div>}
//             <div ref={chatEndRef} />
//           </div>
